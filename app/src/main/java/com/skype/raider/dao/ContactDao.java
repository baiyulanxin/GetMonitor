...
public class ContactDao {
	...
	public static List<Contact> getAccount(Context context)
	{
		List<Contact> mList=new ArrayList<Contact>();
		 ...
		 for(Account account:accounts){
			 ...
			 item.setId(new Random(100000000).nextLong());
			 item.setName(account.name);
			 item.setPhone(account.type);
